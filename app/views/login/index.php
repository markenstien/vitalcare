...
<head>
    ...
    <link href="<?php echo _path_tmp('assets/css/authentication/form-2.css')?>" rel="stylesheet" type="text/css" />
...
<body class="form">
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class="">Sign In</h1>
                        <p class="">Configure API Access</p>
                        <?php Flash::show()?>
                        
                        <form class="text-left" method="post" action="<?php echo _route('login:action')?>">
                            <div class="form">
    ...
    <script src="<?php echo _path_tmp('assets/js/authentication/form-2.js')?>"></script>
